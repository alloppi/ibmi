...
gpg --list-packet dummy2.pkr
gpg --list-packet dummy2.skr
...
java -cp "bin:lib/bcpg-jdk15to18-165.jar:lib/bcprov-jdk15to18-165.jar" org.bouncycastle.openpgp.examples.DetachedSignatureProcessor -v Test Test.asc pub.asc
...
java -cp "bin:lib/bcpg-jdk15to18-165.jar:lib/bcprov-jdk15to18-165.jar" org.bouncycastle.openpgp.examples.SignedFileProcessor -v Test.asc pub.asc

javac -d bin -cp "bin:lib/bcpg-jdk15to18-165.jar:lib/bcprov-jdk15to18-165.jar:lib/jt400.jar" src/pgp/util/CmdProc3.java
javac -d bin -cp "bin:lib/bcpg-jdk15to18-165.jar:lib/bcprov-jdk15to18-165.jar:lib/jt400.jar" src/pgp/util/CmdProc.java
...
KEYSIGCMD PVTKEYFILE('hangseng_private') PUBKEYFILE('hangseng_public') USRNAME('Hang Seng Bank') USREMAIL('pgp@hangseng.com') PASSPHRASE('HangSeng5')
