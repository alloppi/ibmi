      ...
      *
      *    NOTE: This is only included for completeness. For best
      *          performance and simplest coding
      ...
      *                      Use QUSRUSAT to get the library
      ...
      *
      * Consequently
      * array) you can define USE_NESTED_STRUCTURES.  But
      ...
      *
      *  99% of the time
      *      so I have these defined with simple
      *      simplify coding
      *---------------------------------------------------------------
