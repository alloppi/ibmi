     ...
     D                 C                   CONST(128)
      *-----------------------------------------------------------------
      * Time Value Structure (for the ldap_search_st function
      *
      ...
      *
      * Returns a pointer to an LDAP struct
      *-----------------------------------------------------------------
      ...
      *               LDAP parsing routines (ldap_first_entry
      ...
      * deleteoldrdn = Delete old RDN?  1=yes
      ...
      *
      *  Returns the type of the message freed up
      *-----------------------------------------------------------------
      ...
      *
      *  ldap_unbind() and ldap_unbind_s() are both synch
