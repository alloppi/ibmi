      ...
      ****************************************************************
      *
      *  Events you can request poll() to wait for
      *  can return to you:
      *
      ...
      * poll() API to tell it which descriptors to wait on
      * which events to wait for:
      *
      *      fd = descriptor to wait on
      *  events = events to wait for (%bitor of constants
