      * Sample RPG program: BOC_ENC
      * Purpose           : Writing encrypted data to a file
      *
      ...
      * Create an DES algorithm context for the key-encrypting key (KEK)
     ...
     c                   eval      rddata = *all'x1234567890'

      * Open CUSPI file
     C                   open(e)   BOC_KEYF
     C                   if        %error = '1'
     C                   callp     Print('Open of BOC_KEYF failed')
     C                   endif

      * Read first (only) record to get encrypted file key
     C                   read(e)   BOC_KEYFR
     C                   if        %eof = '1'
     C                   callp     Print('BOC_KEYFR record missing')
     C                   close     BOC_KEYF
     C                   endif
