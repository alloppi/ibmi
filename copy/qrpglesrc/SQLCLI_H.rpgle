      ...
      *  InOutType = (input) whether parameter is input
      ...
      *+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      * SQLCancel(): This doesn't do anything
      ...
      *                        columns of a table.
      *
      *  The result data is returned in a result set
      ...
      *  NameLength1 = (input) length of catalog name
      ...
      *  fOption = (input) option to perform
      ...
      *                         if SearchLen = 0)
      *     SearchFor = (input) String to search for
      *                         SrchLocator should be used.
      *     SearchLen = (input) Length of string to search for
      ...
      * vendor escape clauses have been interpreted.  However
      ...
      * it is used to iterate through the parameters
      ...
      *     schemalen = (input) schema len
      *         table = (input) name of table
      *      tablelen = (input) table name len
      *
      * Returns SQL_SUCCESS
      *         SQL_SUCCESS_WITH_INFO
      *         SQL_ERROR
      ...
      *   SchemaLen = (input) Length of SchemaName parm
      *   TableName = (input) Table name to get cols from
      *    TableLen = (input) Length of TableName parm
      ...
      *     Catalog = (input) Must be *omit
      *  CatalogLen = (input) Must be 0
      *  SchemaName = (input) Schema qualifier
      *   SchemaLen = (input) Length of SchemaName parm
      ...
      * TableTypLen = (input) Length of TableType parm
