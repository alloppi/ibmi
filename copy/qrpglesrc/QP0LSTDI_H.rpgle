      ...
      *   typedef struct                        /*                      @B2A*/
      *   {                                     /*                      @B2A*/
      *     uint            Reset_date;         /* Date
      *                                         /*  since Epoch
      *                                         /*  the Days_used_count @B2A*/
      *                                         /*  was reset.          @B2A*/
      *     uint            Last_used_date;     /* Date
      *                                         /*  since Epoch
      *                                         /*  the object was most @B2A*/
      *                                         /*  recently used.      @B2A*/
      *     unsigned short  Days_used_count;    /* Count
      *                                         /*  once each day
      ...
      *                                         /*  journal library     @B6A*/
      *                                         /*  name.               @B6A*/
      *     uint          Time_Last_Started;    /* Date and time
      *                                         /*  seconds since Epoch
      ...
      * Rename File
      *
      *   int Qp0lRenameUnlink(const char *
      *+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     D Qp0lRenameUnlink...
      ...
      *+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      *  Rename File. If another file with new name exists
      *    original names and return an error.
      *
      *  int Qp0lRenameKeep(const char *
      *+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     D Qp0lRenameKeep...
      ...
      *
      *   char *Qp0lGetPathFromFileID(char *
      *+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      *  file
      *
      *  When a user requests access to this stream file again
      ...
      *+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      *  int Qp0lOpen(Qlg_Path_Name_T *
      *
      *   This is the same as open() as defined in IFSIO_H
      ...
      *
      *   This is the same as unlink() as defined in IFSIO_H
      *   that it uses the Qlg_Path_Name_t structure for the pathname
      *+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
