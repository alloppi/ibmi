      *====================================================================*
      * Program name: ZATEST2N                                             *
      * Purpose.....: JSON and REST API Example with OAuth authentication  *
      *                                                                    *
      * Description : Send Sample API to bank (Use YAJL)                   *
      *                                                                    *
      * Modification:                                                      *
      ...
      *
     D s_header        ds                  qualified
     D  reqDate                       8a
     D  reqTime                      10a
     D  businessId                   64a
     D  msgVersion                    4a

     D s_body          ds                  qualified

     D s_sign          ds                  qualified
     D  sign                          4a
      ...
      * 4=order/confirm
      /free
       ...
       yajl_genOpen(*On);              // Turn on "pretty" mode
       yajl_beginObj();                // Start the root object
       yajl_beginObj('header');
       yajl_endObj('header');
       yajl_beginObj;
       yajl_addChar('reqDate':    s_header.reqDate);
       yajl_addChar('businessId': s_header.reqTime);
       yajl_addChar('reqTime':    s_header.businessId);
       yajl_addChar('msgVersion': s_header.msgVersion);
       yajl_endObj;
     ...
     C     @InitRef      BegSr
      ...
      s_header.reqDate = %char(%date(): *iso0);
      s_header.reqTime = %subst(s_header.reqDate:5:4) + %char(%time(): *iso0));
      s_header.businessId = %char(%date(): *iso0 + '00001'));
      s_header.msgVersion = 'v1.0';
